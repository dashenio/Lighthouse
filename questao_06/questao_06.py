...
df_orders = pd.read_csv('questao_06/orders.csv')

df_order_items = pd.read_csv('questao_06/order_items.csv')

df_prod_var = pd.read_csv('questao_06/product_variants.csv')

df_products = pd.read_csv('questao_06/products.csv')
